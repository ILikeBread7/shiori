...
(function() {
	Galv.MBG.v = Number(PluginManager.parameters('ILB7_MessageBackgroundSprite')["Image Variable ID"]);
	Galv.MBG.s = Number(PluginManager.parameters('ILB7_MessageBackgroundSprite')["Disable Switch ID"]);
